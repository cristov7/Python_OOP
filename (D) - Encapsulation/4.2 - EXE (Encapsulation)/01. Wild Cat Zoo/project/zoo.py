...
class Zoo:
    ...
    def animals_status(self) -> str:
        ...
        lion_objects_list = [animal_object.__repr__() for animal_object in self.animals
                             if animal_object.__class__.__name__ == "Lion"]
        amount_of_lions = len(lion_objects_list)
        lions = "\n".join(lion_objects_list)
        tiger_objects_list = [animal_object.__repr__() for animal_object in self.animals
                              if animal_object.__class__.__name__ == "Tiger"]
        amount_of_tigers = len(tiger_objects_list)
        tigers = "\n".join(tiger_objects_list)
        cheetah_objects_list = [animal_object.__repr__() for animal_object in self.animals
                                if animal_object.__class__.__name__ == "Cheetah"]
        amount_of_cheetahs = len(cheetah_objects_list)
        cheetahs = "\n".join(cheetah_objects_list)
